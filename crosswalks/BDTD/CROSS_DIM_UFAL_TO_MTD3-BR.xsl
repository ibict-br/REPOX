...
<xsl:stylesheet version="2.0" 
	...
	<xsl:template match="/">
				...
				<xsl:for-each select="//dim:field[@mdschema='dc'][@element='contributor'][@qualifier='other'][position()=1]">
					<mtd3-br:contributorAdvisor-co1>
						<xsl:value-of select="."/>
					</mtd3-br:contributorAdvisor-co1>
				</xsl:for-each>
				
				<xsl:for-each select="//dim:field[@mdschema='dc'][@element='contributor'][@qualifier='other'][position()=2]">
