...
<xsl:stylesheet version="2.0" 
	...
	<xsl:template match="/">
				...
				<xsl:for-each select="metadata/element[@name='dc']/element[@name='contributor']/element[@name='authorID']">
					<mtd3-br:contributorAuthorID>
						<xsl:value-of select="."/>
					</mtd3-br:contributorAuthorID>
				</xsl:for-each>
				
				<xsl:for-each select="metadata/element[@name='dc']/element[@name='contributor']/element[@name='advisor']">
					<mtd3-br:contributorAdvisor>
						<xsl:value-of select="."/>
					</mtd3-br:contributorAdvisor>
				</xsl:for-each>
			 
				<xsl:for-each select="metadata/element[@name='dc']/element[@name='contributor']/element[@name='advisor-co']">
					<mtd3-br:contributorAdvisor-co>
						<xsl:value-of select="."/>
					</mtd3-br:contributorAdvisor-co>
				</xsl:for-each>
				
				<xsl:for-each select="metadata/element[@name='dc']/element[@name='contributor']/element[@name='referees']">
					<mtd3-br:contributorReferees>
						<xsl:value-of select="."/>
					</mtd3-br:contributorReferees>
				</xsl:for-each>
				
				<xsl:for-each select="metadata/element[@name='dc']/element[@name='date']/element[@name='accessioned']">
					<mtd3-br:dateAccessioned>
						<xsl:value-of select="."/>
					</mtd3-br:dateAccessioned>
				</xsl:for-each>
				
				<xsl:for-each select="metadata/element[@name='dc']/element[@name='date']/element[@name='available']">
					<mtd3-br:dateAvailable>
						<xsl:value-of select="."/>
					</mtd3-br:dateAvailable>
				</xsl:for-each>
				
				<xsl:for-each select="metadata/element[@name='dc']/element[@name='date']/element[@name='issued']">
					<mtd3-br:dateIssued>
						<xsl:value-of select="."/>
					</mtd3-br:dateIssued>
				</xsl:for-each>
				
				<xsl:for-each select="metadata/element[@name='dc']/element[@name='identifier']/element[@name='uri']">
				...
				<!--
				<xsl:for-each select="element[@tag='identifier']/element[@name='uri']">
				...
				-->
				<xsl:for-each select="metadata/element[@name='dc']/element[@name='abstract']">

					<mtd3-br:descriptionAbstract>
					<xsl:if test="fn:exists(metadata/element[@name='dc']/element[@name='abstract']/element)">
							<xsl:attribute name="lang" namespace="">
								<xsl:call-template name="vmf:vmf3_inputtolang">
									<xsl:with-param name="input" select="translate(string(@name), $smallcase, $uppercase)"/>
								</xsl:call-template>
							</xsl:attribute>
						</xsl:if>
						<xsl:value-of select="."/>
				...
				-->
				<xsl:for-each select="metadata/element[@name='dc']/element[@name='contributor']/element[@name='pt_BR']">
					<mtd3-br:publisher>
						<xsl:value-of select="."/>
					</mtd3-br:publisher>
				</xsl:for-each>
	...
	-->
				...
				<xsl:for-each select="metadata/element[@name='dc']/element[@name='type']/element[@name='pt_BR']">
					<mtd3-br:type>
				...
				<xsl:for-each select="metadata/element[@name='dc']/element[@name='title']/element[@name='pt_BR']">
					<mtd3-br:title>
						<xsl:value-of select="."/>
					</mtd3-br:title>
				</xsl:for-each>
				...
				<xsl:for-each select="metadata/element[@name='dc']/element[@name='language']/element[@name='iso']">
					<mtd3-br:language>
						<xsl:call-template name="vmf:vmf3_inputtolang">
								<xsl:with-param name="input" select="translate(string(metadata/element[@name='dc']/element[@name='language']/element[@name='iso']), $smallcase, $uppercase)"/>
							</xsl:call-template>	
						</mtd3-br:language>
				</xsl:for-each>
				...
				-->
				<xsl:for-each select="metadata/element[@name='dc']/element[@name='subject']/element[@name='classification']">
					<mtd3-br:subject>
					<xsl:if test="fn:exists(metadata/element[@name='dc']/element[@name='subject']/element[@name='classification']/element)">
							<xsl:attribute name="lang" namespace="">
								<xsl:call-template name="vmf:vmf3_inputtolang">
									<xsl:with-param name="input" select="translate(string(@name), $smallcase, $uppercase)"/>
								</xsl:call-template>
