...
<!--
			<xsl:for-each select="$var1_mtdbr">
				<xsl:variable name="instituicao" select="normalize-space(substring-before(fn:string(ns0:InstituicaoDefesa/ns0:Nome),'. '))"/>
-->				
			<mtd3-br:publisher>
				<xsl:text>Universidade Estadual de Campinas</xsl:text>
			</mtd3-br:publisher>
	...
	<!--		</xsl:for-each> -->
			...
			<xsl:for-each select="$var1_mtdbr">
				<xsl:variable name="departamento" select="normalize-space(substring-after(fn:string(ns0:InstituicaoDefesa/ns0:Nome),'. '))"/>
