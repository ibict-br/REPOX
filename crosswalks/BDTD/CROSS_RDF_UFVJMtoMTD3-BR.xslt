...
<xsl:stylesheet version="2.0" 
	...
	<xsl:template match="/">
			 ...
			 <!-- ??? -->
				...
				<xsl:if test="fn:exists(//dc:identifier[1])">
				...
				<xsl:if test="fn:exists(//dc:description[1])">
				...
				<mtd3-br:publisher>
					<xsl:text>Universidade Federal dos Vales do Jequitinhonha e Mucuri</xsl:text>
				</mtd3-br:publisher>
				...
				<xsl:if test="fn:exists(//dc:degree[3])">
					<mtd3-br:publisherDepartament>
						<xsl:value-of select="//dc:degree[3]"/>
					</mtd3-br:publisherDepartament>
				</xsl:if>
			   
			    <xsl:if test="fn:exists(//dc:publisher[2])">
					<mtd3-br:publisherProgram>
						<xsl:value-of select="//dc:publisher[2]"/>
					</mtd3-br:publisherProgram>
				</xsl:if>
				...
				<xsl:if test="fn:exists(//dc:degree[2])">
					<mtd3-br:type>
						<xsl:call-template name="vmf:vmf3_inputtotype">
							<xsl:with-param name="input" select="translate(string(//dc:degree[2]), $smallcase, $uppercase)"/>
						</xsl:call-template>
					</mtd3-br:type>
				</xsl:if>
